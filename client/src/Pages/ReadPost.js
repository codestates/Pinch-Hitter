      ...
      <WrapperDiv>
        <Body>
          ...
          <SectorWrapper>
            ...
            <RTitleInput readOnly value="강남 CU편의점 대타해주실분 구해요!" />
            <IndexDiv>지역</IndexDiv>
            <RTitleInput readOnly value="강남" />
            <IndexDiv>날짜</IndexDiv>
            <RTitleInput readOnly value="2022-05-20" />
            <IndexDiv>직종</IndexDiv>
            <RTitleInput readOnly value="편의점" />
            <IndexDiv>시급</IndexDiv>
            <RTitleInput readOnly value="10,000원 이상" />
          </SectorWrapper>
